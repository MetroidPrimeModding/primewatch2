...
//      json_player["gun"]
  ...
  json parsePool() {
    ...
    transform(inOrder.begin(), inOrder.end(), back_inserter(ids),
              [](CSimplePool::ResourceType pair) { return pair.b.json(); });
  ...
  json parsePoolBasic() {
    ...
    transform(inOrder.begin(), inOrder.end(), back_inserter(ids),
              [](CSimplePool::ResourceType pair) { return pair.a.id.read(); });
